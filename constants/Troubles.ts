    ...
    return [
      {
        ...
        probability: 0.1,
        resolutionOptions: [
          { name: "Hire Top Lawyers", cost: 500000, influenceCost: 0, successProbability: 0.8 },
          { name: "Bribe Officials", cost: 250000, influenceCost: 10, successProbability: 0.6 },
          { name: "Comply and Pay Fines", cost: 2000000, influenceCost: 0, successProbability: 1 },
        ],
      },
      {
        id: "2",
        ...
        resolutionOptions: [
          ...
          { name: "Silence Whistleblowers", cost: 50000, influenceCost: 20, successProbability: 0.5 },
      ...
      },
      {
        ...
        probability: 0.08,
        resolutionOptions: [
          { name: "Negotiate with Union", cost: 200000, influenceCost: 5, successProbability: 0.75 },
          { name: "Hire Replacement Workers", cost: 30000, influenceCost: 15, successProbability: 0.6 },
          { name: "Improve Working Conditions", cost: 350000, influenceCost: 0, successProbability: 0.95 },
        ],
      },
      {
        id: "4",
