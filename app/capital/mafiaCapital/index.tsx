...
const MafiaCapital = () => {
  ...
  const { mafiaInfluence } = useBusinessContext();

  let interestRate;

  if (mafiaInfluence < 6) {
    interestRate = [9, 8, 8, 7];
  } else if (mafiaInfluence > 6 && mafiaInfluence < 25) {
    interestRate = [7, 6, 6, 5];
  } else if (mafiaInfluence > 25 && mafiaInfluence < 100) {
      ...
      <ScrollView style={{ maxHeight: "auto", flex: 1 }}>
        ...
        <View style={[styles.containerThree, { marginTop: 150 }]}>
          <View style={[styles.containerThree, { marginBottom: 20 }]}>
            ...
            >
              Build Relations with Mafias & Oligarchs to get investment, loans and special
              treatments. Higher the mafia influence, lower the interest you have to
              pay.
            </Text>
          </View>
