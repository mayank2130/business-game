...
const MafiaRelations = () => {
  ...
  const mafiaRelationOptions = [
    { id: "mafia", amount: 3000000, level: "Local Thugs", influence: 1 },
    {
      id: "mafia",
      amount: 25000000,
    ...
    { id: "mafia", amount: 250000000, level: "Russian Oligarchs", influence: 7 },
  ];
      ...
      <ScrollView style={{ maxHeight: "auto", flex: 1 }}>
        <View style={[styles.containerThree, { marginTop: 100 }]}>
          <View style={[styles.containerThree, { marginBottom: 10 }]}>
            ...
            >
              Building Relations with the mafia gets you protection, and ability
              to carry out some unconventional tasks.
            </Text>
          </View>

          {mafiaRelationOptions.map((item, index) => (
